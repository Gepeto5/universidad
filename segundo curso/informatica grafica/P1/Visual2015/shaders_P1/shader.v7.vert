...
in vec2 inTexCoord;								//atributo de coordenada de textura que llega de los vertices
...
out vec2 textureCoord;							/variable variante que usamos para pasar la textura al shader de fragmentos
