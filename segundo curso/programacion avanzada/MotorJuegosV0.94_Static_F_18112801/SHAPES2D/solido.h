...
public:
	...
	/* Metodos de acceso static */
	inline static double getMAX() { return MAX; }
	inline static void setMAX(double d) { MAX = d; }
	inline static long getNumSolidos() { return numSolidos; }
	/* Metodos de acceso */
